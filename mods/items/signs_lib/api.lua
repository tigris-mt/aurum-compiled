...
-- Boolean indicating whether to assume the existence of the standard Minetest Game.
signs_lib.standard = minetest.settings:get_bool("signs_lib_standard", true)
...
signs_lib.standard_wood_groups = signs_lib.standard and table.copy(minetest.registered_items["default:sign_wall_wood"].groups) or {}
signs_lib.standard_wood_groups.sign = 1
signs_lib.standard_wood_groups.attached_node = nil

signs_lib.standard_steel_groups = signs_lib.standard and table.copy(minetest.registered_items["default:sign_wall_steel"].groups) or {}
signs_lib.standard_steel_groups.sign = 1
signs_lib.standard_steel_groups.attached_node = nil

signs_lib.standard_wood_sign_sounds  = signs_lib.standard and table.copy(minetest.registered_items["default:sign_wall_wood"].sounds) or nil
signs_lib.standard_steel_sign_sounds = signs_lib.standard and table.copy(minetest.registered_items["default:sign_wall_steel"].sounds) or nil

signs_lib.standard_wood_pole_texture = "default_wood.png"
...
function signs_lib.register_sign(name, raw_def)
	...
	if raw_def.allow_yard then
		...
		ydef.tiles[3] = raw_def.tiles[5] or signs_lib.standard_wood_pole_texture
